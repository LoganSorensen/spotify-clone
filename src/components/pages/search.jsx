...
const SearchPage = (props) => {
  ...
  return (
    <div className="search-results">
      ...
      <div className="songs search-category">
        <h3>Songs</h3>
        {tracks &&
      ...
      <div className="artists search-category">
        <h3>Artists</h3>
        {artists &&
      ...
      <div className="albums search-category">
        <h3>Albums</h3>
        {albums &&
            ...
            return (
              <Link key={index} to={`/album/${album.id}`} className="album">
                ...
                <div className="album-search-info">
                  ...
                  <p className="light">{truncateStr(album.artists[0].name)}</p>
                </div>
              </Link>
            );
          })}
      </div>
      <div className="playlists search-category">
        <h3>Playlists</h3>
        {playlists &&
      ...
      <div className="shows search-category">
      ...
      <div className="episodes search-category">
